...
const PartyWear = () => {
  ...
  const filteredProducts = partyProducts.filter(product => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-12 text-center">
          <h1 className="text-5xl font-bold text-gray-900 mb-4">Party Collection</h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Turn heads at every party with our glamorous collection. From sequined dresses 
            to sophisticated blazers, we have everything to make you shine.
          </p>
        </div>
          ...
          <div className="lg:w-3/4">
            ...
            {filteredProducts.length === 0 && (
              <div className="text-center py-16">
                ...
                <h3 className="text-2xl font-semibold text-gray-700 mb-2">No party wear found</h3>
